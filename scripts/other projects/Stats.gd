...
func  _ready() -> void:
	extr_front_defense = rand_range(5,105)
	extr_back_defense = rand_range(5,105)
	extr_flank_defense = rand_range(5,105)
	convertStats()
...
remotesync func getHit(attacker: KinematicBody, damage: float, damage_type: int, extra_penetrate_chance: float) -> void:
