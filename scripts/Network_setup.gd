...
onready var server_ip_text_edit = $Multiplayer_configure/serverip
...
#						player.rpc("update_position", spawn_location.global_translation)
#						player.rpc("enable")
#						current_spawn_location_instance_number += 1
...
func instance_player(id) -> void:
	var player_instance = Global.instance_node_at_location(player, Persistent_nodes, Vector3(0,5,0))
