...
onready var touched_grass_label:Label = $TouchGrass
var harvested_item_size:float 
var harvested_item:Node = null
var touched_grass:Node = null
func debugHarvesting() -> void:
	
	if touched_grass != null:
		touched_grass_label.text = "touched: " + touched_grass.name +  "\n"
...
onready var effects_label:Label =  $DebugEffects
var effect_error:String = ""
func debugEffects() -> void:
	effects_label.text = effect_error
	if Engine.get_physics_frames() % 96 == 0:
		effect_error = ""
